...
public class Data {
    ...
    private static Station st1, st2, st3, st4, st5, st6, st7, st8, st9, st10, st11, st12,
            ...
            st25, st26;
    private static final Station[] stations1 = {st1, st2, st3, st4, st5, st6, st7, st8};
    private static final Station[] stations2 = {st9, st10, st11, st12, st13, st3, st4, st5, st6, st7, st8};
    private static final Station[] stations3 = {st14, st15, st13, st3, st4, st6, st7};
    ...
    private static void initializeStations() {
        ...
        // AZUL
        st1 = new Station("Senhora de Matosinhos", Zone.MTS1,false);
        ...
        // VERMELHA
        st9 = new Station("Povoa de Varzim", Zone.PVVC1,false);
        ...
        // AMARELA
        st16 = new Station("Hospital Sao Joao", Zone.PRT3,false);
        st17 = new Station("Polo Universitario", Zone.PRT3,false);
        st18 = new Station("Marques", Zone.PRT1,false);
        //st6- Trindade
        st19 = new Station("Sao Bento", Zone.PRT1,false);
        st20 = new Station("General Torres", Zone.VNG1,false);
        st21 = new Station("Santo Ovidio", Zone.VNG1,false);

        // ROXA
        st22 = new Station("Aeroporto", Zone.VCD2,false);
        st23 = new Station("Custoias", Zone.MAI2,false);
        //st13 - Fonte do Cuco
        //st3 - Senhora da Hora
        //st4 - Ramalde
        //st5 - Casa da Música
        ...
        st26 = new Station("Fanzeres", Zone.GDM1,false);
    }
    ...
    public static Station[] getStations(){
        Station[] newStations = null;
        for(int i = 0; i<stations.length;i++){
            for(int j = 0;j<stations[i].length;j++){
                newStations = stations[j];
            }
        }
        return newStations;
    }
